<?php
namespace DatabaseLogger\Test\Fixture;
...
class LoggingFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ip' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'hostname' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'user' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'type_index' => ['type' => 'index', 'columns' => ['type'], 'length' => []],
            'user_index' => ['type' => 'index', 'columns' => ['user'], 'length' => []],
        ],
        '_constraints' => [
